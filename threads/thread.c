...
void thread_unblock(struct thread *t)
{
	...
	// list_push_back(&ready_list, &t->elem);	// 기본 스레드
	list_insert_ordered(&ready_list, &t->elem, cmp_priority, NULL); // 내가 추가
...
{
	thread_current()->priority = new_priority; // 내가 추가
	test_max_priority();
	refresh_priority();
}
...
void test_max_priority(void)
{
	...
	struct thread *curr = running_thread();
	int ready_p = ready_head->priority;
	int curr_p = curr->priority;
